...
Learn more about Kestra at LearnDataEngineering.com [Learn more](https://learndataengineering.com/p/partners-kestra)
Visit the Kestra homepage: [Kestra.io](kestra.io)
...
You’ll also learn how to run real code inside workflows using Python and Java, how to synchronize code from GitHubusing native Kestra sync tasks, and how to build reusable pipeline logic with subflows.
